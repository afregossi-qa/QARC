...
2. **Binary files**: LiteDB (.db), images (.png/.jpg), and other binary files cannot be read by the agent. State "not analyzed (binary file)" — never describe their contents based on filename alone.
