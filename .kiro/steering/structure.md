...
Allowed at ticket root: `.state.json`, `AIO_SYNC_LOG.md`, `REMEDIATION_LOG.md`, `REMEDIATION_ESCALATION.md`, `LESSONS_LEARNED.md`, `QA_DASHBOARD.md`, `SUMMARY.md`, `*_ERROR.md`, `Automation_Blueprint*.md`
